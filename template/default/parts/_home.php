...
<div id="slims-home">
    <section class="mt-5 container">
        ...
        <ul class="topic d-flex flex-wrap justify-content-center px-0">
            <li class="d-flex justify-content-center align-items-center m-2">
                <a href="https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=unidha&btnG=" class="d-flex flex-column">
                    <img src="<?php echo assets('images/chrome.png'); ?>" width="80" class="mb-3 mx-auto" />
                    <?php echo __('Artikel'); ?>
                </a>
            </li>
              <li class="d-flex justify-content-center align-items-center m-2">
                <a href="http://jurnal.unidha.ac.id/index.php/JEBD" class="d-flex flex-column">
                    <img src="<?php echo assets('images/journal.png'); ?>" width="80" class="mb-3 mx-auto" />
                    <?php echo __('Journal'); ?>
                </a>
            </li>
    ...
    <?php if ($sysconf['template']['classic_map']) : ?>
        <section class="my-5 container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <iframe class="embed-responsive" src="<?= $sysconf['template']['classic_map_link']; ?>" height="420" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
